...
public class AmberHoeItem extends HoeItem {
    public AmberHoeItem(Tier tier, int attackMod, float attackSpeedMod, Properties props) {
    ...
    public InteractionResult useOn(UseOnContext p_40637_) {
        ...
        if (applyGrowth(p_40637_.getItemInHand(), level, blockpos, p_40637_.getPlayer())) {
    ...
    public static boolean applyGrowth(ItemStack p_40628_, Level p_40629_, BlockPos p_40630_, net.minecraft.world.entity.player.Player player) {
