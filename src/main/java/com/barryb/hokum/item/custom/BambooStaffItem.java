...
public class BambooStaffItem extends BlockItem {


    public BambooStaffItem(Block p_40565_, Properties p_40566_) {
    ...
    public void appendHoverText(ItemStack p_41421_, @Nullable Level p_41422_, List<Component> components, TooltipFlag p_41424_) {
        components.add(Component.literal("Right Click to place an Amber Scaffolding block").withStyle(ChatFormatting.ITALIC).withStyle(ChatFormatting.GRAY));
