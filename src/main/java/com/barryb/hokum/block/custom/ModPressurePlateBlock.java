...
public class ModPressurePlateBlock extends BasePressurePlateBlock {
    ...
    private final ModPressurePlateBlock.Sensitivity sensitivity;

    public ModPressurePlateBlock(ModPressurePlateBlock.Sensitivity p_55253_, BlockBehaviour.Properties p_55254_) {
        super(p_55254_);
