...
@OnlyIn(Dist.CLIENT)
public class SludgeonRenderer extends MobRenderer<Slime, SlimeModel<Slime>> {
    private static final ResourceLocation SLUDGEON_TEXTURES = new ResourceLocation(Hokum.MODID, "textures/entity/sludgeon.png");

    public SludgeonRenderer(EntityRendererProvider.Context p_174391_) {
